...
namespace aiko
{
    ...
    public:
        ...
        void loadTextureAsset(const AssetId& id);
        void loadMeshAsset(const AssetId& id);
        void loadModelAsset(const AssetId& id);
        void loadShaderAsset(const AssetId& id);
        void loadComputeShaderAsset(const AssetId& id);
